...
ThemeData light(BuildContext context) => ThemeData(
  cardColor: Colors.orange, // Change to a light color
  colorScheme: ColorScheme.fromSwatch().copyWith(
    primary: Colors.blueGrey, // Change to a light color
    secondary: Colors.grey, // Change to a lighter color
  ),
  sliderTheme: SliderTheme.of(context).copyWith(
    ...
    thumbColor: Colors.indigoAccent, // You might want to change this to a lighter color
    inactiveTrackColor: Colors.grey, // Change to a lighter color for inactive track
